...
group_bar=px.bar(
    ...
    width=1500,
    title=dict(
        text=f'{current_month} Admin Groups',
        x=0.5, 
        font=dict(
            size=25,
            family='Calibri',
...
collab_bar=px.bar(
    ...
    width=1500,
    title=dict(
        text=f'{current_month} Admin Collaborated Entities',
        x=0.5, 
        font=dict(
            size=25,
            family='Calibri',
...
html.Div(
    ...
    children=[
        html.Div(
            ...
            html.Div(
                className='high1',
                children=[f'{current_month} Admin Events']
            ),
            html.Div(
                className='circle',
                children=[
...
html.Div(
    ...
    children=[
        html.Div(
            ...
            html.Div(
                className='high1',
                children=[f'{current_month} Admin Hours']
            ),
            html.Div(
                className='circle',
                children=[
